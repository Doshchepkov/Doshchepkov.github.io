...
![Множество Кантора, кривая Коха, треугольник Серпинского](1.png){#fig:001 width=70%}
...
![Фрактальный агрегат](0.png){#fig:002 width=70%}

![Примеры анизотропных агрегатов для 3, 4, 5, и 6 осей симметрии](2.png){#fig:003 width=70%}
...
![Образование гелей (Gelation transition)](3.png){#fig:004 width=70%}
...
![Стадии образования кластеров](4.png){#fig:005 width=70%}
